...
class USGSCollector:
    ...
    def get_daily_streamflow(
        ...
        try:
            logger.info("Fetching daily streamflow", site=self.site, start=start_date, end=end_date, parameters=parameters)
            df = nwis.get_dv(
                sites=self.site,
    ...
    def get_instantaneous_streamflow(
        ...
        try:
            logger.info("Fetching instantaneous streamflow", site=self.site, start=start_date, end=end_date)
